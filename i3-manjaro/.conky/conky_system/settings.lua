...
function draw_function(cr)
    ...
    local gap_x_fix = 15
    local gap_y_fix = 15
    local start_rect_width_no_battery = 15
    ...
    if battery then
        ...
        draw_circle(cr,(start_rect_width_no_battery)+gap_x_fix,gap_y_fix,r_RAM,g_RAM,b_RAM,transparency_RAM,tostring(tonumber(conky_parse('${memperc}'))))
